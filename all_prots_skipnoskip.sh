...
(perl poissonnolim.pl -p h3 --state nsyn --step 0.5 --restrictions 50,100 --onlysim --simnumber 10000 --maxmem 25000000 --skip_stoppers_in_simulation --mutnum_control 0 --shuffler_type exp  --output skipnoskip &>output/logs/h3_skipnoskip ;
...
(perl poissonnolim.pl -p h1 --state nsyn --step 0.5 --restrictions 50,100 --onlysim --simnumber 10000 --maxmem 25000000 --skip_stoppers_in_simulation --mutnum_control 0 --shuffler_type exp  --output skipnoskip &>output/logs/h1_skipnoskip ;
...
(perl poissonnolim.pl -p n2 --state nsyn --step 0.5 --restrictions 50,100 --onlysim --simnumber 10000 --maxmem 25000000 --skip_stoppers_in_simulation --mutnum_control 0 --shuffler_type exp  --output skipnoskip &>output/logs/n2_skipnoskip ;
...
perl poissonnolim.pl -p n1 --state nsyn --step 0.5 --restrictions 50,100 --onlysim --simnumber 10000 --maxmem 25000000 --skip_stoppers_in_simulation --mutnum_control 0 --shuffler_type exp  --output skipnoskip &>output/logs/n1_skipnoskip
