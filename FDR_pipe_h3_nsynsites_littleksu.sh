		...
		do
			it=$((number+10*i))
				...
				out="${foldername}/${it}_fake"
 				perl single_sites_nolim.pl -p h3 --state nsyn --input little_ksu --step 0.00005 --restrictions 0.03 --skip_stoppers --mutnum_control 0 --output $out &>output/logs/fakes_littleksu_nsynsites &
		done
		wait
