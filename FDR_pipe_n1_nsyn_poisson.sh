...
foldername="nolim_massive_fakes_poisson_n1"
for i in {0..10}
do
		for number in {1..10}
		do
			it=$((number+10*i))
				...
				sleep 3
				( perl poissonnolim.pl -p n1 --state nsyn --distrpoisson --simnumber 1000 --mutnum_control 0 --fake --shuffler_type exp --maxmem 60000000 --output $out ;
