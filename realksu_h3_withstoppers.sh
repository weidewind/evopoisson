...
--skip_stoppers_in_simulation --onlysim --mutnum_control 0 \
...
--mutnum_control 0 --fails_threshold 0.5 --output $outputname &>"output/logs/${outputname}_groups" &
perl single_sites_nolim.pl -p $prot --state $state --input $inputname --step 0.00005 --restrictions 0 \
--mutnum_control 0 --output $outputname &>output/logs/${outputname}_sites &
wait
