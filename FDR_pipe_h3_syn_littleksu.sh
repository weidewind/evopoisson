...
do
		...
		do
			it=$((number+10*i))
				...
				( perl poissonnolim.pl -p h3 --state syn --input little_ksu --step 0.00005 --restrictions 0.03,0.06 --simnumber 1000 --mutnum_control 0 --fake --shuffler_type exp --maxmem 25000000 --output $out &>output/logs/fakes_littleksu_syn;
