...
echo $PERL5LIB
~/perl5/perlbrew/perls/perl-5.22.1/bin/perl poisson.pl --protein h1 --state syn --output synresearch --no_leaves --switch @cluster.conf
echo h1 done 
~/perl5/perlbrew/perls/perl-5.22.1/bin/perl poisson.pl --protein h3 --state syn --output synresearch --no_leaves --switch @cluster.conf 
echo h3 done 
~/perl5/perlbrew/perls/perl-5.22.1/bin/perl poisson.pl --protein n1 --state syn --output synresearch --no_leaves --switch @cluster.conf 
echo n1 done 
~/perl5/perlbrew/perls/perl-5.22.1/bin/perl poisson.pl --protein n2 --state syn --output synresearch --no_leaves --switch @cluster.conf
echo n2 done 
