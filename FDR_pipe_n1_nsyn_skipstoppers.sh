...
foldername="nolim_nobin_newdist_supermassive_fakes_n1_skipstoppers"
for i in {0..49}
do
		for number in {1..10}
		do
			it=$((number+10*i))
				...
				sleep 3
				( perl poissonnolim.pl -p n1 --state nsyn --skip_stoppers --simnumber 1000 --mutnum_control 0 --fake --shuffler_type exp --maxmem 10000000 --output $out ;
